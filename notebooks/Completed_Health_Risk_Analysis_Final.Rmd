...
---
title: "Completed Health Risk Analysis"
...
#print(bmi_plot)
![bmi_plot](../outputs/figures/bmi_distribution.png)
...
#print(scatter_plot)
![scatter_plot](../outputs/figures/age_vs_cholesterol.png)
...
![correlation_heatmap](../outputs/figures/correlation_heatmap.png)
#====================================================
...
#print(bmi_boxplot)
![bmi_boxplot](../outputs/figures/bmi_boxplot.png)
...
![risk_histogram](../outputs/figures/risk_histogram.png)
#------------------------------------------------------------
...
#print(scree_plot)
![scree_plot](../outputs/figures/scree_plot.png)
...
![pca_individual_plot](../outputs/figures/pca_individual_plot.png)
